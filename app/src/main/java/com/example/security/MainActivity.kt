    ...
    setContent {
      ...
      AppTheme(darkTheme = darkTheme) {
        Column(
          ...
          TextField(value = key, onValueChange = { key = it }, label = { Text(text = "key") })
          TextField(value = value, onValueChange = { value = it }, label = { Text(text = "value") })
          Button(
            onClick = {
              sharedPref.edit {
                putString(key, value)
          ...
          Button(
            onClick = {
              text = sharedPref.getString(key, "").orEmpty()
            }
          ) {
            Text(text = "load")
          }
